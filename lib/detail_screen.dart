...
class EnergyLevelSlider extends StatefulWidget {
  const EnergyLevelSlider({Key? key}) : super(key: key);

  @override
  State<EnergyLevelSlider> createState() => _EnergyLevelSliderState();
}

class _EnergyLevelSliderState extends State<EnergyLevelSlider> {
